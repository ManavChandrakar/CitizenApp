...
import com.pris.citizenapp.Fragments.FragmentPropertyTax;
...
public class Linkpptadapter extends RecyclerView.Adapter<Linkpptadapter.FeedViewHolder> {
    ...
    public Linkpptadapter(List<PropertyDatamodel> contactList, Context fm)
    {
    ...
    @Override
    public void onBindViewHolder(final Linkpptadapter.FeedViewHolder feedViewHolder, final int i) {
        ...
        feedViewHolder.imvadd.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    @Override
    public Linkpptadapter.FeedViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new Linkpptadapter.FeedViewHolder(itemView);
    }
    ...
    public static class FeedViewHolder extends RecyclerView.ViewHolder {
        ...
        public FeedViewHolder(View v) {
            ...
            imvadd=(ImageView)v.findViewById(R.id.imvadd);
        }
    }

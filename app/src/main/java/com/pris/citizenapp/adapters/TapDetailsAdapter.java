...
public class TapDetailsAdapter extends RecyclerView.Adapter<TapDetailsAdapter.FeedViewHolder>{
    ...
    public TapDetailsAdapter(List<Replies> contactList, Context fm)
    {
    ...
    @Override
    public TapDetailsAdapter.FeedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new TapDetailsAdapter.FeedViewHolder(itemView);
    }

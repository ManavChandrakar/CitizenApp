...
public class RegisterOtp extends AppCompatActivity {
    ...
    Toolbar toolbar;
    TextView tv1,tv2;
    EditText choosepass,confirmpass;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.register_otp);
        toolbar=(Toolbar)findViewById(R.id.toolbar);
        toolbar.setTitle("Registration Otp");
        setSupportActionBar(toolbar);

        tv1=(TextView)findViewById(R.id.tv1);
        tv2=(TextView)findViewById(R.id.tv2);
        choosepass=(EditText)findViewById(R.id.choosepass);
    ...
    public  void verifyOtp(){
       ...
       else if(!(choosepass.getText().toString().trim().equals(confirmpass.getText().toString().trim())))
        {
            popAlert.setContent("Password Mismatch");
            popAlert.show();
        }

        else if(choosepass.getText().toString().trim().length()<6)
        {
            popAlert.setContent("Choose 6 digit password");
            popAlert.show();
        }
            ...
            if(session.haveNetworkConnection()){
                ...
                params.put("password",choosepass.getText().toString().trim());
            ...
            try {
                ...
                if(res.trim().equals("success")) {
                    ...
                    if (result.has("verifyOtp")) {
                        ...
                        Intent intent = new Intent(RegisterOtp.this, FooterMain.class);

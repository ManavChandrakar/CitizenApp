...
import com.pris.citizenapp.Fragments.FragmentTradeTax;
...
public class TradeLicenceTax  extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Trade Licence Tax");
        //Creating our pager adapter
        adapter = new Pager(getSupportFragmentManager());

        adapter.addFragemnt(new FragmentTradeTax(),"Trade Licence Tax");

...
import com.pris.citizenapp.Fragments.FragmentPrivateTap;
...
public class PrivateTap extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initializing viewPager
         setTitle("Private Tap Tax");
        //Creating our pager adapter
        adapter = new Pager(getSupportFragmentManager());

        adapter.addFragemnt(new FragmentPrivateTap(),"Private tap Tax");

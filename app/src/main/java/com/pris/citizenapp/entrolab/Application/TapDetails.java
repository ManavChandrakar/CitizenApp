...
import com.pris.citizenapp.adapters.TapDetailsAdapter;
...
public class TapDetails extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Private Tap Details");
        ...
        TapDetailsAdapter ca = new TapDetailsAdapter(challenge,this);

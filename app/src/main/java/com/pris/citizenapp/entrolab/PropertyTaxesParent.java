...
public class PropertyTaxesParent extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Creating our pager adapter
         ...
         adapter.addFragemnt(new FragmentPropertyTax(),"Property Tax");

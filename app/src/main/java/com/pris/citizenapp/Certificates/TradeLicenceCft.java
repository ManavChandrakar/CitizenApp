...
public class TradeLicenceCft extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if(res)
                {
                    if(session.haveNetworkConnection()) {
                        ...
                        Toast.makeText(TradeLicenceCft.this, "Please make sure that you are connected to an Active Internet connection!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        protected void onPostExecute(String response){
            ...
            try {
                ...
                if(res.trim().equals("success")){
                    ...
                    Intent intent = new Intent(TradeLicenceCft.this, CertificateOtp.class);
